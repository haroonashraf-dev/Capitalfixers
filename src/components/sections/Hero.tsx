...
export default function Hero() {
  return (
    <section className="relative pt-2 sm:pt-6 pb-16 lg:pt-4 lg:pb-24 overflow-hidden bg-slate-50">
      ...
      {/* Blur Orbs */}
      <div
        className="absolute top-0 right-0 w-125 h-125 bg-blue-200/30 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/3 pointer-events-none"
        style={{ transform: "translateZ(0)" }}
      />
      <div
        className="absolute bottom-1/4 left-0 w-100 h-100 bg-sky-200/30 rounded-full blur-[100px] translate-y-1/2 -translate-x-1/2 pointer-events-none"
        style={{ transform: "translateZ(0)" }}
      />
        ...
        <div className="flex flex-row items-start justify-between w-full">
          ...
          <div className="w-[55%] md:w-1/2 pr-4 sm:pr-8 text-left py-4 sm:py-8 lg:py-12">
            ...
            <div className="flex flex-row items-center justify-start gap-2 sm:gap-4 mb-6 sm:mb-12 w-full">
              ...
              >
                <PhoneCall className="w-3.5 h-3.5 sm:w-5 sm:h-5 hidden sm:block" />{" "}
                Call Now
              </a>
              <Link
                to="/services"
              ...
              >
                Services{" "}
                <ArrowRight className="w-3.5 h-3.5 sm:w-5 sm:h-5 text-slate-400 hidden sm:block" />
              </Link>
            </div>
            ...
            <div className="flex flex-row items-center justify-start gap-3 sm:gap-6 border-t border-slate-200/60 pt-4 sm:pt-8 mt-4 sm:mt-8">
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="flex-col sm:flex-row flex text-left">
                  ...
                  <div className="text-[9px] sm:text-sm font-bold text-slate-600 leading-tight">
                    2k+ Happy <br className="sm:hidden" />
                    Customers
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 sm:gap-3 text-left">
                ...
                <div>
                  <div className="text-[9px] sm:text-sm font-bold text-slate-900 leading-tight">
                    Verified Pros
                  </div>
                </div>
              </div>
          ...
          <div className="w-[45%] md:w-1/2 relative mt-12 sm:mt-16 md:mt-0 pt-0 lg:pt-4 translate-y-1">
           ...
           <div className="relative z-10 w-full h-[280px] sm:h-[400px] md:h-[500px] lg:h-[600px] rounded-l-2xl sm:rounded-l-[2.5rem] rounded-r-none overflow-hidden shadow-2xl border-2 sm:border-4 border-r-0 border-white -mr-2 sm:-mr-4 md:-mr-6 lg:-mr-8">
            ...
            <div className="absolute top-[10%] sm:top-8 -left-6 sm:-left-12 lg:-left-16 bg-white p-2 sm:p-4 rounded-lg sm:rounded-2xl shadow-xl border border-slate-100 z-30 flex items-center gap-2 sm:gap-4 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
              ...
              <div>
                <div className="text-[6px] sm:text-xs text-slate-400 font-bold mb-0.5">
                ...
                <div className="text-[10px] sm:text-sm font-extrabold text-slate-900 flex items-center gap-1 sm:gap-1.5">
                  <Clock className="w-2.5 h-2.5 sm:w-4 sm:h-4 text-blue-600" />{" "}
                  45 Mins
                </div>
              </div>
            </div>
